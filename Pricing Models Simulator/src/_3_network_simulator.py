...
from _2_rule_based import RuleBasedPricing
...
def run_simulation(users, strategy, network_capacity, iterations=100):
    if strategy == 'static':
        model = StaticPricing()
...
if __name__ == "__main__":
    ...
    for strategy in ['static', 'rule_based', 'q_learning']:
        results[strategy] = run_simulation(users, strategy, network_capacity, iterations=2000)
